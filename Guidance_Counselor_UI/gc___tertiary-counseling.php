                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <ul class="breadcome-menu">
                                    ...
                                    <li><a href="gc___tertiary-reports.php"><span class="bread-blod">Tertiary Reports</span></a>
                                        <span class="bread-slash">/</span>
                                    </li>
                                    <li><span class="bread-blod">Tertiary Under Counseling Services</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1>Tertiary<span class="table-project-n"> Under Counseling Services</span> </h1>
                            </div>
                            ...
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                ...
                                <table id="table" data-toggle="table" data-search="true" data-show-columns="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Types of Counseling</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <li>Counselor-initiated</li>
                                            </td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
