                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <div class="product-payment-inner-st res-mg-t-30 analysis-progrebar-ctn">
                        <ul id="myTabedu1" class="tab-review-design">
                            ...
                            <li class="active"><a href="#description"><small>Offense Monitoring</small></a></li>
                            <!-- <li><a href="#reviews"><small>Appointment Info</small></a></li> -->
                            <!-- <li><a href="#reset"><small>Reset Password</small></a></li> -->
                            <li><a href="#INDIVIDUAL_INVENTORY"><small>Inventory Form</small></a></li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div id="inventory-form-cointainer">
                                                    ...
                                                    <?php
                                                        ...
                                                        if ($row == 0) {
                                                            ?>
                                                            <p>Individual Inventory Not Yet Filled Up!</p>
                                                        <?php
                                                        } else {
                                                            do {
                                                                ?>
                                                                                        ...
                                                                                        <div class="details_personal">
                                                                                            <div class="fields">
                                                                                                ...
                                                                                                <div class="input-field">
                                                                                                    ...
                                                                                                    <input type="text" name="mname" placeholder="Enter your middle name" value="<?php echo $row['MIDDLE']; ?>" required>
                                                                                                </div>
