              ...
              <div class="panel-heading hbuilt mailbox-hd">
                <div class="text-center p-xs font-normal">
                  ...
                  <div class="input-group">
                    <form method="POST">
                      <input type="text" id="searchs" class="form-control" placeholder="Search students...">
                      <span class="input-group-btn active-hook">

                        <button type="button" id="btn_search" class="btn btn-sm btn-default">Search</button>

                        <button type="button" id="reload" class="btn btn-sm btn-default">Reload</button>
