                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1><span class="table-project-n"> Edit Guidance Counselor</span> Account</h1>
                        </div>
                        ...
                        ?>
                                ...
                                <form action="thecode.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="edit_username" value="<?php echo $row['GC_USERNAME'] ?>" class="form-control" placeholder="Enter Username">
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
