                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <ul class="breadcome-menu">
                                    ...
                                    <li><a href="gc___tertiary-reports.php"><span class="bread-blod">SHS Reports</span></a>
                                        <span class="bread-slash">/</span>
                                    </li>
                                    <li><span class="bread-blod">SHS Under Counseling Services</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1>SHS<span class="table-project-n"> Under Counseling Services</span> </h1>
                            </div>
