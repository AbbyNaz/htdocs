...
if(!isset($_SESSION['UserEmail'])) {
    ...
    $con = connection();
    $refferal = "SELECT * FROM users LEFT JOIN refferals ON refferals.reffered_user = users.user_id WHERE refferals.ref_id IS NOT NULL AND refferals.ref_status NOT LIKE '%Complete%' AND refferals.ref_status NOT LIKE '%Cancelled%' ORDER BY refferals.reffered_date DESC";
