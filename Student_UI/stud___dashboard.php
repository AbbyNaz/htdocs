          ...
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <div class="breadcome-heading">
                <!-- <a >NOTE: Students are allowed to have one (1) appointment, If you wish to change your appointment schedule please cancel your previous request</a> <span class="bread-slash"></span> -->
...
<div class="modal fade" id="req-form" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-body">
          ...
          <div class="form-group-inner">
            <div class="row">
              ...
              <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                <input type="text" id="view-information" class="form-control"
                  placeholder="Enter Appointment Information" disabled />
              </div>
            </div>
          </div>
