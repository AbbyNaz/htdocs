                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sparkline13-list">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="../Student_UI/stud___set_referral.php" style="margin: 10px; height: 40px;">Cancel</a>
                            <button type="submit" name="update_referral" class="btn btn-primary btn-md" style="margin: 10px; height: 40px;">Update</button>
                        </div>
                    </form>
