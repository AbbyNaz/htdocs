...
<div class="left-sidebar-pro">
    <nav id="sidebar" class="">
        <div class="sidebar-header">
            <br>
            <a href="stud___dashboard.php"><img class="main-logo" src="img/sti_logo.png" width="60px" height="80px" /></a>
            <strong><a href="stud___dashboard.php"><img src="img/sti_logo.png" alt="" /></a></strong>
        </div>
        <br>
