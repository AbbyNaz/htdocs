    ...
    $.ajax({
        ...
        $.each(data.response, (index, user)=>{
            ...
            if(user.profile_picture){
                userprofile = "../Student_UI/sms_show_profile.php?id="+user.id_number;
            }else{
                userprofile = "../Student_UI/img/profile/prof2.png";
            }
    ...
    $.ajax({
        ...
        $.each(data.response, (index, sms)=>{
            ...
            if(sms.profile_picture){
                profile = "../Student_UI/sms_show_profile.php?id="+sms.id_number;
            }else{
                profile = "../Student_UI/img/profile/prof2.png";
            }
